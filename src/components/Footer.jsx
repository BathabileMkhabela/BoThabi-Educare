    ...
    <footer className={styles.footer}>
      <div className={styles.footerContent}>
        <div className={styles.footerSection}>
          <h3 className={styles.footerTitle}>BoThabi EduCare</h3>
          <p className={styles.footerDescription}>
            Empowering people with computer fundamentals and Java coding skills. 
        ...
        <div className={styles.footerSection}>
          ...
          <ul className={styles.footerLinks}>
            ...
            <li><Link to="/courses" className={styles.footerLink}>Courses</Link></li>
        ...
        <div className={styles.footerSection}>
          <h4 className={styles.footerSubtitle}>Our Courses</h4>
          <ul className={styles.footerLinks}>
            <li><Link to="/courses/computer-fundamentals" className={styles.footerLink}>Computer Fundamentals</Link></li>
            <li><Link to="/courses/java-basics" className={styles.footerLink}>Coding skills With Java</Link></li>
          </ul>
        </div>
        ...
        <div className={styles.footerSection}>
          ...
          <div className={styles.contactInfo}>
            <div className={styles.contactItem}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className={styles.contactIcon}>
                <path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V8l8 5 8-5v10zm-8-7L4 6h16l-8 5z"/>
              </svg>
              <span>info@bothabi-educare.com</span>
            </div>
            <div className={styles.contactItem}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className={styles.contactIcon}>
                <path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/>
              </svg>
              <span>+27637234846</span>
            </div>
            <div className={styles.contactItem}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className={styles.contactIcon}>
                <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 010-5 2.5 2.5 0 010 5z"/>
              </svg>
              <span>123 Education Street, Gaborone, Botswana</span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.footerSection}>
          ...
          <p className={styles.newsletterText}>Subscribe to our newsletter for updates on new courses and events.</p>
      ...
      <div className={styles.footerBottom}>
        <div className={styles.footerBottomContent}>
          <p>&copy; {new Date().getFullYear()} BoThabi EduCare. All rights reserved.</p>
